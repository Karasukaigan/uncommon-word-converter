/**
 * 用Node.js+Express搭建一个本地服务器来接收浏览器发来的请求。
 * 
 * Author：Karasukaigan
...
/**
 * 将接收到的文字转换为同音字，然后发回浏览器。
 */
app.get('/main', function (req, res) {
    var str = req.query['str'];
    var conversion_result = change(str)
    console.log(str + " > " + conversion_result);
    res.end(conversion_result);
})

/**
 * 拼音库，引用自sxei的储存库pinyinjs。
 * Author: sxei
